...
class MathSkill(BaseSkill):
    ...
    def description(self) -> str:
        return """Выполняет математические вычисления: арифметика, алгебра, производные, интегралы, пределы, решение уравнений.
Используй этот навык когда пользователь просит:
- Посчитать выражение (2+2, 15*3, sqrt(16))
- Найти производную или интеграл
- Решить уравнение
- Упростить выражение"""

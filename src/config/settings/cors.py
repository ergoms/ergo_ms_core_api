...
Для продакшена (в т.ч. внешние IP, например 109.196.100.16) в .env задают:
  - CORS_ALLOWED_ORIGINS — список полных origin'ов: http://109.196.100.16:5173,http://109.196.100.16:8001,...
  - или CORS_ALLOWED_ORIGIN_REGEXES — regex-шаблоны, например: ^https?://109\\.196\\.100\\.16(:\\d+)?$
...
_CORS_DEV_HOSTS = ('localhost', '127.0.0.1', '109.196.100.16')
_default_origins = [

...
- true  — пользователи могут менять email, ФИО и телефон в настройках профиля (по умолчанию)
- false — email, ФИО и телефон меняют только глобальные администраторы; пользователи отправляют заявки
"""
